...
high-end commercial style, vibrant and inviting`,
    ...
    imageUpload: {
      ...
      hint: 'Best with clean background. AI will create a styled hero shot.',
      required: false,
      type: 'product',
    },
...
clean background with subtle gradient`,
    ...
    imageUpload: {
      enabled: true,
      label: 'Upload Product Photo',
      hint: 'Upload the product to highlight. AI will focus on the feature.',
      required: false,
      type: 'product',
    },
  },
...
modern typography aesthetic, shopping bags or products in background`,
    ...
    imageUpload: {
      enabled: true,
      label: 'Upload Sale Items Photo',
      hint: 'Optional: Upload products on sale for background imagery.',
      required: false,
      type: 'product',
    },
  },
...
clean divider line, realistic transformation result`,
    ...
    imageUpload: {
      ...
      hint: 'Upload the before state. AI will create a split comparison.',
      required: false,
      type: 'scene',
    },
  },
...
cohesive color scheme, professional commercial style, overhead shot`,
    ...
    imageUpload: {
      enabled: true,
      label: 'Upload Bundle Items',
      hint: 'Upload photos of items in the bundle for a flat lay composition.',
      required: false,
      type: 'product',
    },
  },
